...
public class bankData {
    ...
    public void displayData()
    {
        ...
        {
            bankData myBank = new bankData(100,100);
            myBank.toWithdraw(true);
            myBank.setWithdraw(100);
            myBank.toTransfer(true);
            myBank.setTransfer(100);
            myBank.toDeposit(true);
            myBank.setDeposit(100);
            myBank.displayData();
        }        
